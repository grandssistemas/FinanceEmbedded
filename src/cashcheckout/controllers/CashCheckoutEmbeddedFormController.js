import BalanceModal from '../views/BalanceModal.html';
...
function CashCheckoutEmbeddedFormController(
	...
	$scope.$ctrl.$onInit = function () {
		...
		$scope.getDefaultTransfer = function (param) {
			...
			return FinanceUnitService.getAdvancedSearch(hql).then((data) => data.data.values);
		};
...
export default CashCheckoutEmbeddedFormController;
