...
import jqueryUi from '../../bower_components/jquery-ui/jquery-ui.min.js';
import remarkableBootstrapNotify from '../../bower_components/remarkable-bootstrap-notify/dist/bootstrap-notify.min.js';
import moment from '../../bower_components/moment/min/moment-with-locales.min.js';
import momentTimezone from '../../bower_components/moment-timezone/builds/moment-timezone-with-data.min.js';
