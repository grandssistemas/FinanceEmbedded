import modalTemplate from '../views/viewermodal.html';

function FinanceReportService(GumgaRest, $uibModal, FinanceEmbeddedService) {
	const service = new GumgaRest(`${FinanceEmbeddedService.getDefaultConfiguration().api}/financereport`);
	...
	service.getDefault = (type) => service.extend('get', `/getdefault/${type}`);
