	...
	$scope.conf = {
		...
		columnsConfig: [
			...
			},
			{
				...
				size: 'col-md-1',
				title: '  ',
				content: '<button style="display:inline-block" type="button" ng-if="!(!$value.oi || !$value.oi.value)" ng-click="$parent.$parent.$parent.editReport($value)" uib-tooltip="Editar" class="btn-link center-block text-primary"><i class="fa fa-pencil-square-o"></i></button>' +
