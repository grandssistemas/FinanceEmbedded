!function(modules) {
    ...
    Object.defineProperty(exports, "__esModule", {
        value: !0
    }), exports.default = angular.module("group.dependencies", [ "gumga.rest", "gumga.controller", "gumga.alert", "gumga.webstorage", "gumga.manytoone", "gumga.address", "gumga.translate", "gumga.mask", "gumga.upload", "gumga.customfields", "gumga.counter", "gumga.breadcrumb", "gumga.confirm", "gumga.onetomany", "gumga.populate", "gumga.manytomany", "gumga.form", "gumga.queryfilter", "gumga.genericfilter", "gumga.list", "gumga.date", "ui.utils.masks", "gumga.layout", "ui.select" ]);
}, function(module, exports, __webpack_require__) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: !0
    ...
    (function(moment) {
        function TitleParcelPayListEmbeddedController($uibModal, $scope, TitleParcelPayService, gumgaController, $timeout, IndividualEmbeddedService) {
            ...
            $scope.aqFilterSelected = null, $scope.getParcels = function(date, page) {
                ...
                TitleParcelPayService.findOpenByMaxDate(null, "PAY", page, $scope.individualSearch, $scope.paidOut, $scope.aqFilterSelected).then(function(data) {
                    $scope.selectedValues = [], $scope.titleparcelPay.data = data.data.values, $scope.titleparcelPay.pageSize = data.data.pageSize, 
                    $scope.titleparcelPay.count = data.data.count;
                });
    ...
    (function(moment) {
        function TitleParcelReceiveListEmbeddedController(TitleService, FinanceConfigurationService, $uibModal, $scope, TitleParcelPayService, gumgaController, $timeout, IndividualEmbeddedService) {
            ...
            $scope.hideOthers = !0, $scope.getParcels = function(date, page) {
                ...
                $scope.lastClicked = null, $scope.aqFilterSelected = null, delete $scope.filters, 
                delete $scope.individualSearch;
            }, $scope.getParcels(null, 1), $scope.filter = function(whichFilter, individual) {
                $scope.lastClicked = whichFilter, individual && ($scope.individualSearch = individual);
                ...
                $scope.aqFilterSelected = aq, $scope.titleparcel.methods.advancedSearch(aq);
            }, $scope.searchByIndividual = function(individual) {
                $scope.getParcels($scope.endDate, 1);
            }, $scope.receive = function(page) {
                $scope.lastClicked = null, $scope.aqFilterSelected = null, $scope.paidOut = !0, 
                TitleParcelPayService.findOpenByMaxDate(null, "RECEIVE", page, $scope.individualSearch, $scope.paidOut, $scope.aqFilterSelected).then(function(data) {
                    $scope.selectedValues = [], $scope.titleparcel.data = data.data.values, $scope.titleparcel.pageSize = data.data.pageSize, 
                    $scope.titleparcel.count = data.data.count;
                });
