!function(modules) {
    ...
    function FinanceReportListEmbeddedController($scope, FinanceReportService, gumgaController, $state, $q, SweetAlert, $rootScope, TitleService) {
        ...
        $scope.status = $scope.statusList[0], $scope.filterClient = null, console.log($scope.filterClient), 
        ...
        $scope.viewReport = function(entity) {
            ...
            variables.push(mountVariable("", "filterClient", $scope.filterClient)), console.log($scope.filterClient), 
