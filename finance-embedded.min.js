!function(modules) {
    ...
    "use strict";
    module.exports = angular.module("finance.stimulsoftembedded.service", []).service("FinanceReportService", __webpack_require__(49));
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    function TitleEmbeddedService(GumgaRest, $http, FinanceEmbeddedService) {
        ...
        return Service.renegociationParcels = [], Service.setRenegociationParcels = function(values) {
            ...
            return aqParam && (aq = aq + " AND " + aqParam), $http.get(FinanceEmbeddedService.getDefaultConfiguration().api + "/title/joinparticipations?aq=" + aq + "&sortField=emissionDate&sortDir=desc&start=" + page);
    ...
    function CashCheckoutEmbeddedFormController($scope, CashCheckinEmbeddedService, FinanceUnitService, SweetAlert, MoneyUtilsService, $filter, $uibModal) {
        function validateDiference(entity) {
            for (var i = 0; i < entity.values.length; i++) if (!isComparationCorrect(entity.values[i], entity.destinyChange)) return console.log(entity.values[i], entity.destinyChange), 
            SweetAlert.swal("Diferença de Valores!", "A conta " + entity.values[i].financeUnit.name + " esta com diferença de valores, realize movimentações de caixa para corrigir antes de fechar.", "error"), 
            !1;
            return !0;
        }
    ...
    function TitleListEmbeddedController($scope, TitleService, FinanceReportService, SweetAlert, $uibModal, gumgaController) {
        ...
        $scope.title.on("deleteSuccess", function() {
            ...
            console.log($scope.selected), $scope.selected.labels.clear(), $scope.selected.labels[0] = label, 
    ...
    function ReceivePrintEmbeddedController($scope, $uibModalInstance, items, $filter) {
        ...
        console.log($scope.recibo.value), $scope.receiptValue = $filter("gumgaNumberInWords")($scope.recibo.value.toString().replace(".", ","), !0), 
    ...
    function DesignerEmbeddedController($scope, $window, FinanceReportService, $uibModal) {
        ...
        function changeOnCreate(designer) {
            designer.onCreateReport = function(event) {
                if (headerfooter && headerfooter.jsonReport) {
                    ...
                    report.loadFromJsonInternal(headerfooter.jsonReport), event.isWizardUsed = !1, event.report = report, 
        ...
        $scope.back = function() {
            ...
            if ($scope.entity.id) report.load($scope.entity.report.definition); else {
                headerfooter && headerfooter.jsonReport && (report.loadFromJsonInternal(headerfooter.jsonReport), 
                report.reportFile = ""), report.dictionary.databases.clear();
            ...
            report.dictionary.variable = $scope.variable, changeSaveReport(designer), changeOnCreate(designer), 
            designer.report = report, designer.renderHtml("designer");
        };
    }
    ...
    function ViewerEmbeddedController($scope, $window, FinanceReportService) {
        function init() {
            console.log("load"), StiOptions.WebServer.url = FinanceReportService.connectionLocal;
            ...
            console.log(jsonReport), $scope.entity.id && report.load(jsonReport), report.dictionary.variable = variableVar, 
    ...
    FinanceReportService.$inject = [ "GumgaRest", "$uibModal", "apiLocation" ], module.exports = FinanceReportService;
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    var finance = angular.module("finance.embedded", [ "ui.bootstrap", "group.dependencies", "finance.providers", "finance.services", "finance.title", "finance.titleparcel", "finance.titleparcelreceive", "finance.stimulsoftembedded", "finance.cashcheckinembedded", "finance.cashcheckoutembedded" ]);
