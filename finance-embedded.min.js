!function(modules) {
    ...
    (module.exports = __webpack_require__(74)).tz.load(__webpack_require__(73));
}, function(module, exports, __webpack_require__) {
    "use strict";
    module.exports = angular.module("finance.providers", []).provider("FinanceEmbeddedService", __webpack_require__(53));
}, function(module, exports, __webpack_require__) {
    "use strict";
    __webpack_require__(3), module.exports = angular.module("finance.stimulsoftembedded.controllers", [ "finance.stimulsoftembedded.service" ]).controller("DesignerEmbeddedController", __webpack_require__(47)).controller("FinanceReportListEmbeddedController", __webpack_require__(48)).controller("ReportTypeModalEmbeddedController", __webpack_require__(49)).controller("ViewerEmbeddedController", __webpack_require__(50));
}, function(module, exports, __webpack_require__) {
    "use strict";
    __webpack_require__(1), module.exports = angular.module("finance.stimulsoftembedded.service", [ "finance.providers" ]).service("FinanceReportService", __webpack_require__(51));
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    function FinanceUnitGroupService(GumgaRest, FinanceEmbeddedService) {
        var service = new GumgaRest(FinanceEmbeddedService.getDefaultConfiguration().api + "/financeunitgroup"), group = void 0;
        return service.getOpen = function() {
            if (!group) {
                var cash = sessionStorage.getItem("groupOpen");
                return "undefined" !== cash ? group = JSON.parse(cash) : null;
            }
            return group;
        }, service.getUpdateGroup = function() {
            if (!group) {
                var cash = sessionStorage.getItem("groupOpen");
                if ("undefined" === cash || "null" === cash) return service.getDefaultGroup().then(function(data) {
                    return service.setGroup(data.data), data.data;
                });
                group = JSON.parse(cash);
            }
            return service.getById(group.id).then(function(data) {
                return service.setGroup(data.data), group;
            });
        }, service.setGroup = function(value) {
            sessionStorage.setItem("groupOpen", JSON.stringify(value)), group = value;
        }, service.removeSessionGroup = function() {
            sessionStorage.removeItem("groupOpen"), group = null;
    ...
    function TitleEmbeddedService(GumgaRest, $http, FinanceEmbeddedService) {
        ...
        return Service.renegociationParcels = [], Service.setRenegociationParcels = function(values) {
            ...
            return aqParam && (aq = aq + " AND " + aqParam), $http.get(FinanceEmbeddedService.getDefaultConfiguration().api + "/title/joinparticipations?aq=" + aq + "&sortField=id&sortDir=desc&start=" + page);
    ...
    "use strict";
    module.exports = angular.module("group.dependencies", [ "gumga.rest", "gumga.controller", "gumga.alert", "gumga.webstorage", "gumga.manytoone", "gumga.address", "gumga.translate", "gumga.mask", "gumga.upload", "gumga.customfields", "gumga.counter", "gumga.breadcrumb", "gumga.confirm", "gumga.onetomany", "gumga.populate", "gumga.manytomany", "gumga.form", "gumga.queryfilter", "gumga.genericfilter", "gumga.list", "gumga.date", "gumga.numberinwords", "ui.utils.masks", "gumga.layout", "ui.select" ]);
}, function(module, exports, __webpack_require__) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
        value: !0
    ...
    "use strict";
    module.exports = angular.module("finance.cashcheckinembedded", []).controller("CashCheckinEmbeddedFormController", __webpack_require__(22)).component("cashCheckinEmbedded", __webpack_require__(21));
}, function(module, exports, __webpack_require__) {
    "use strict";
    __webpack_require__(77), module.exports = angular.module("finance.cashcheckoutembedded", []).controller("CashCheckoutEmbeddedFormController", __webpack_require__(25)).controller("BalanceModalController", __webpack_require__(24)).component("cashCheckoutEmbedded", __webpack_require__(23));
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    "use strict";
    module.exports = angular.module("finance.titleparcel", [ "finance.services" ]).controller("TitleParcelPayListEmbeddedController", __webpack_require__(38)).controller("ReceivePrintEmbeddedController", __webpack_require__(37)).controller("PayEmbeddedController", __webpack_require__(36)).component("financeTitleParcelPayPayment", __webpack_require__(35)).component("financeTitleParcelPayList", __webpack_require__(34));
}, function(module, exports, __webpack_require__) {
    "use strict";
    module.exports = angular.module("finance.titleparcelreceive", [ "finance.services", "finance.titleparcel" ]).controller("TitleParcelReceiveListEmbeddedController", __webpack_require__(42)).controller("PayReceiveEmbeddedController", __webpack_require__(41)).component("financeTitleParcelReceivePayment", __webpack_require__(40)).component("financeTitleParcelReceiveList", __webpack_require__(39));
}, function(module, exports, __webpack_require__) {
    "use strict";
    __webpack_require__(46), __webpack_require__(2), __webpack_require__(3), __webpack_require__(1), 
    ...
    function CashCheckinEmbeddedFormController($scope, CashCheckinEmbeddedService, FinanceUnitGroupService, FinanceUnitService, $filter, $timeout) {
        function onSelectGroup(value) {
            ...
            $scope.entity.destinyChange = void 0;
        }
    ...
    "use strict";
    function CashCheckoutEmbeddedFormController($scope, CashCheckinEmbeddedService, FinanceUnitService, SweetAlert, MoneyUtilsService, $filter, $uibModal) {
        ...
        function isComparationCorrect(value, destiny) {
            ...
            value.movementedValue === MoneyUtilsService.sumMoney(value.informedValue, change);
        }
    ...
    CashCheckoutEmbeddedFormController.$inject = [ "$scope", "CashCheckinEmbeddedService", "FinanceUnitService", "SweetAlert", "MoneyUtilsService", "$filter", "$uibModal" ], 
    ...
    "use strict";
    function PaymentsModalController($scope, $uibModalInstance, payments) {
        $scope.payments = angular.copy(payments), $scope.payments.forEach(function(payment) {
            payment.value < 0 && (payment.value = -1 * payment.value);
        }), $scope.tableConfig = {
    ...
    PaymentsModalController.$inject = [ "$scope", "$uibModalInstance", "payments" ], 
    module.exports = PaymentsModalController;
}, function(module, exports, __webpack_require__) {
    "use strict";
    function ReceiveTitlePrintModalController($scope, $uibModalInstance, id, FinanceReportService, SweetAlert) {
        $scope.options = [ {
            value: "Duplicata",
            key: "DUPLICATE"
        }, {
            ...
            var variables = [], title = void 0, message = void 0;
            switch (variables.add(FinanceReportService.mountVariable("Empresa", "idTitle", id)), 
            type) {
              case "DUPLICATE":
                var user = JSON.parse(sessionStorage.getItem("user"));
                variables.add(FinanceReportService.mountVariable("Empresa", "nameEmployee", user.name)), 
                title = "Falta de Relatorio de Duplicatas", message = "Você esta sem o relátorio de duplicatas contate o suporte.";
                break;

              case "CARNET":
                title = "Falta de Relatorio de Carnê", message = "Você esta sem o relátorio de carnê contate o suporte.";
                break;

              case "PROMISSORY":
                title = "Falta de Relatorio de Promissória", message = "Você esta sem o relátorio de promissória contate o suporte.";
            }
            FinanceReportService.openModalViewer(type, "", variables, function() {
    ...
    ReceiveTitlePrintModalController.$inject = [ "$scope", "$uibModalInstance", "id", "FinanceReportService", "SweetAlert" ], 
    module.exports = ReceiveTitlePrintModalController;
}, function(module, exports, __webpack_require__) {
    "use strict";
    (function(moment) {
        function TitleFormEmbeddedController(TitleService, $uibModal, $scope, gumgaController, $timeout, IndividualEmbeddedService, DocumentTypeService, RatioPlanService, PlanLeafService, WalletService, FinanceUnitService, SweetAlert, MoneyUtils, TitleParcelPayService, $state) {
            if ($scope.entity = angular.copy($scope.$ctrl.entity), $scope.entity.data.parcel.sort(function(a, b) {
            ...
            $scope.step = 1, $scope.interestActive = !0, $scope.blockBtnSave = function(formInvalid) {
                return formInvalid;
            }, $scope.updatePaid = function(invalid) {
                invalid || $scope.launchPaid();
            }, $scope.update = function(invalid, entity) {
                invalid || $scope.save(entity);
            }, $scope.backToList = function() {
                var title;
                title = "editreceive" === $scope.titleType ? "receive" : "pay", $state.go("title.list" + title);
            }, $scope.ratioPlanSearch = function(param) {
                return param = param || "", $scope.ratioPlan.methods.asyncSearchWithGQuery(new GQuery(new Criteria("obj.name", ComparisonOperator.CONTAINS, param).addTranslate().addIgnoreCase()));
            }, TitleService.getPlanTree().then(function(response) {
                ...
                value.label && value && RatioPlanService.getAutomaticRatio(value.label, total).then(function(response) {
                    $scope.title.data.planLeafs = response.data;
                });
            }, $scope.disable = !1, $scope.changeStep = function(numStep) {
                1 === numStep && ($scope.title.data.hasPayment || $scope.title.data.fullPaid || $scope.renegotiation || $scope.title.data.isReversed ? ($scope.disable = !0, 
                $scope.step = numStep) : ($scope.disable = !1, $scope.step = numStep)), 2 === numStep && ($scope.disable = !1, 
                $scope.step = numStep);
                ...
                plan.subPlanLeafs || (plan.subPlanLeafs = []), void 0 === query && (query = "");
            ...
            $scope.title.data.billetCollection = $scope.title.data.billetCollection || 0, $scope.title.data.memo = $scope.title.data.memo || $scope.$ctrl.voice || "", 
            ...
            $scope.title.data.expiration = $scope.title.data.expiration || new Date(), "PAY" === $scope.title.data.titleType && $scope.title.data.parcel[0] && ($scope.title.data.value = $scope.title.data.parcel[0].value), 
            ...
            $scope.verifyParcelDate = function(parcel) {
                $scope.dateNull = !parcel.expiration || null === parcel.expiration;
            }, ($scope.title.data.hasPayment || $scope.title.data.fullPaid || $scope.title.data.isReversed) && ($scope.disable = !0), 
            ...
            $scope.save = function(entity) {
                ...
                $scope.disable || ($scope.title.data.expiration && ($scope.title.data.expiration = new Date($scope.title.data.expiration), 
            ...
            var setExpiration = function(parcel, expiration) {
                var dateNew = 0 === parcel ? expiration.setMonth(expiration.getMonth()) : expiration.setMonth(expiration.getMonth() + 1);
                return new Date(dateNew);
            };
            $scope.calculateParcels = function() {
                var valueParcel = $scope.title.data.value, numberParcel = $scope.title.data.numberParcel, valueParcelReceive = parseFloat((valueParcel / numberParcel).toFixed(2)), valueRemainingCalculateReceive = parseFloat((valueParcel - valueParcelReceive * numberParcel).toFixed(2));
                $scope.title.data.parcel = [], valueParcel / numberParcel < .01 && (SweetAlert.swal("Atenção!", "O valor das parcelas não deve ser menor que R$ 0,01 centavo", "warning"), 
            ...
            }, $scope.totalSumParcel = $scope.sumParcels($scope.title.data.parcel), $scope.changeValueParcel = function(payment, oldValue) {
                !angular.equals(oldValue, payment.value) && $scope.title.data.parcel.length > 1 && SweetAlert.swal({
                    title: "Valor",
                    ...
                    if (isConfirm) {
                        for (var index = $scope.title.data.parcel.indexOf(payment), totalParcels = 0, i = 0; i <= index; i++) totalParcels += $scope.title.data.parcel[i].value || 0;
                        if (totalParcels > $scope.totalSumParcel) return SweetAlert.swal("Atenção!", "O valor da soma das parcelas não deve ser maior que o valor total da venda", "error"), 
                        void (payment.value = oldValue);
                        var index = $scope.title.data.parcel.indexOf(payment) + 1, restValue = $scope.totalSumParcel - totalParcels, countParcels = $scope.title.data.parcel.length - index, parcelValue = restValue / countParcels, total = 0, count = 0;
                        parcelValue = MoneyUtils.roundMoney(parcelValue);
                        for (var parcelRemainder = 100 * restValue % countParcels / 100, parcelRemainder = parcelRemainder < .01 ? 0 : parcelRemainder, i = index; i < $scope.title.data.parcel.length; i++) count++, 
                        $scope.title.data.parcel[i].value = parcelValue, total = MoneyUtils.sumMoney(total, parcelValue), 
                        1 === count && 0 !== parcelRemainder && ($scope.title.data.parcel[i].value = MoneyUtils.sumMoney($scope.title.data.parcel[i].value, parcelRemainder), 
                        total = MoneyUtils.sumMoney(total, parcelRemainder)), count === countParcels && restValue !== MoneyUtils.roundMoney(total) && ($scope.title.data.parcel[i].value = MoneyUtils.sumMoney($scope.title.data.parcel[i].value, MoneyUtils.sumMoney(restValue, -total)));
                        swal("Alterado!", "Os valores foram alterados", "success");
                    } else payment.value = oldValue, swal("Mantido", "Os valores foram mantidos :)", "success");
                });
                ...
                params.fullPaid || ($scope.paymentRest += params.value), "1" === params.number && ($scope.title.data.expiration = moment.tz(params.expiration, "America/Sao_Paulo").toDate() || new Date());
            }), $scope.showBarCodeTitle = function() {
                return "PAY" == $scope.title.data.titleType;
            }, $scope.showPayments = function(parcel) {
                if (!parcel.parcelPayments.length) return void SweetAlert.swal("Nenhum pagamento encontrado", "Nenhum pagamento foi realizado para a parcela selecionada.", "warning");
                TitleParcelPayService.getPaymentsByParcel(parcel.id).then(function(data) {
                    var _payments = data.data;
                    $uibModal.open({
                        animation: !0,
        ...
        var template = __webpack_require__(82), templatePayments = __webpack_require__(79);
        TitleFormEmbeddedController.$inject = [ "TitleService", "$uibModal", "$scope", "gumgaController", "$timeout", "IndividualEmbeddedService", "DocumentTypeService", "RatioPlanService", "PlanLeafService", "WalletService", "FinanceUnitService", "SweetAlert", "MoneyUtilsService", "TitleParcelPayService", "$state" ], 
        module.exports = TitleFormEmbeddedController;
    }).call(exports, __webpack_require__(0));
}, function(module, exports, __webpack_require__) {
    "use strict";
    function TitleListEmbeddedController($scope, TitleService, FinanceReportService, SweetAlert, $uibModal, gumgaController) {
        ...
        $scope.title.on("deleteSuccess", function() {
        ...
        }, $scope.selected = {}, $scope.labels = [], TitleService.getLabels().then(function(response) {
            $scope.labels = response.data.values;
        }, function(error) {
            console.error(error.data);
            ...
            $scope.selected.labels.clear(), $scope.selected.labels[0] = label, TitleService.searchTags(label.value, $scope.titleType.toUpperCase()).then(function(response) {
                $scope.title.data = response.data.values;
            });
        }, $scope.reset = function() {
            $scope.title.methods.get(1);
        }, $scope.titleList = [], $scope.tableConf = {
        ...
        }, $scope.openPrintings = function(_id) {
            $uibModal.open({
            ...
            var result = void 0;
            return parcels.length < 1 ? null : (parcels.forEach(function(parcel) {
                if (result || parcel.fullPaid) {
                    if (!parcel.fullPaid) {
                        var dateIndex = new Date(parcel), dateResult = new Date(result);
                        dateResult > dateIndex && (result = dateIndex);
                    }
                } else result = parcel;
            }), result || parcels.forEach(function(parcel) {
                if (result) {
                    var dateIndex = new Date(parcel);
                    new Date(result) > dateIndex && (result = dateIndex);
                } else result = parcel;
            }), result.expiration);
        }, $scope.print = function(type) {
            var typePrint = "receive" === type ? "RECEIVE_BILL" : null;
            FinanceReportService.openModalViewer(typePrint, "", [], function() {
    ...
    var modalTemplate = __webpack_require__(83);
    TitleListEmbeddedController.$inject = [ "$scope", "TitleService", "FinanceReportService", "SweetAlert", "$uibModal", "gumgaController" ], 
    ...
    "use strict";
    (function(moment) {
        function PayEmbeddedController(FinanceConfigurationService, $scope, $timeout, TitleParcelPayService, FinanceUnitService, CheckingAccountService, ThirdPartyChequeService, gumgaController, PaymentService, $uibModal, LocalCashService, ChequePortfolioService, $filter, IndividualCreditService, MoneyUtilsService, PercentageFinanceUtilsService, CreditCardAccountService) {
            function getInterestValue(value, expiredDays) {
                var interest = value.interest.value;
                return expiredDays ? MoneyUtilsService.divideMoney(MoneyUtilsService.multiplyMoney(PercentageFinanceUtilsService.multiply6(interest, value.value), expiredDays), 30) : 0;
            }
            function getPenaltyValue(value, expiredDays) {
                var penalty = value.penalty.value;
                return expiredDays ? MoneyUtilsService.roundMoney(PercentageFinanceUtilsService.multiply6(penalty, value.value)) : 0;
            }
            function getDiscountValue(value) {
                var discount = value.discount.value;
            ...
            function getExpiredDays(value) {
                var diff = moment(value).diff(moment(), "days");
                return diff < 0 ? -diff : 0;
            }
            function getInterestPerc(value, interrest, expiredDays) {
                return expiredDays ? PercentageFinanceUtilsService.multiply6(30, PercentageFinanceUtilsService.divide6(PercentageFinanceUtilsService.divide6(interrest, expiredDays), value.value)) : 0;
            }
            function getPenaltyPerc(value, penalty, expiredDays) {
                return expiredDays ? PercentageFinanceUtilsService.divide6(penalty, value.value) : 0;
            }
            ...
            gumgaController.createRestMethods($scope, FinanceUnitService, "financeunit"), $scope.getPersonalCredits = function(params) {
            ...
            $scope.cheques.data = [], $scope.filtered = [], $scope.chequeList = [], $scope.listCheques = function(id, param) {
                return id = id || 0, param = param || "", ThirdPartyChequeService.getAdvancedSearch("lower(obj.issuer.name) like lower('%" + param + "%') and obj.portfolio.id = " + id + " and obj.status = 'AVAILABLE'").then(function(data) {
            ...
            $scope.uploadError = function(e) {}, $scope.totalize = function() {
                ...
                return total;
            }, $scope.getRemainingValue = function(row) {
                var expiredDays = getExpiredDays(row.expiration), interestValue = getInterestValue(row, expiredDays), penaltyValue = getPenaltyValue(row, expiredDays), discountValue = getDiscountValue(row), value = MoneyUtilsService.sumMoney(row.value, MoneyUtilsService.sumMoney(interestValue, MoneyUtilsService.sumMoney(penaltyValue, -discountValue)));
                return MoneyUtilsService.sumMoney(value, -row.totalpayed);
            }, $scope.totalizeRemaining = function() {
                return $scope.payment.parcels.reduce(function(sum, current) {
                ...
                $scope.addPayment(methodPayment, "check"), $scope.chequeList = [], $scope.cheques.data = [], 
                $scope.payment.check = {}, $scope.payment.check.checks = [];
                ...
                $scope.totalSelecionado = $scope.payment.check.checks.map(function(a) {
                    return a.value;
                }).reduce(function(a, b) {
                    return a + b;
                }, 0), $scope.payment.value = $scope.totalSelecionado, $scope.itemsSelected = $scope.payment.check.checks;
                ...
                columnsConfig: [ {
                    ...
                    content: '<input type="text" ui-money-mask ng-change="$parent.$parent.updateTotal($value,interestValue,penaltyValue,discountValue)" ng-disabled="!$parent.$parent.isExpired($value.expiration)" ng-init="interestValue = $parent.$parent.calcInterestValue($value)" ng-model="interestValue">'
                }, {
                    name: "penalty",
                    editable: !0,
                    title: "<span>Multa</span>",
                    content: '<input type="text" ui-money-mask ng-change="$parent.$parent.updateTotal($value,interestValue,penaltyValue,discountValue)" ng-disabled="!$parent.$parent.isExpired($value.expiration)" ng-init="penaltyValue = $parent.$parent.calcPenaltyValue($value)" ng-model="penaltyValue">'
                }, {
                    name: "discount",
                    editable: !0,
                    title: "<span>Desconto</span>",
                    content: '<input type="text" ui-money-mask ng-change="$parent.$parent.updateTotal($value,interestValue,penaltyValue,discountValue)" ng-init="discountValue = $parent.$parent.calcDiscountValue($value)" ng-model="discountValue">'
                }, {
                    name: "remaining",
                ...
                PaymentService.pay(payment).then(function() {
                    $scope.$ctrl.onBackClick();
                }), $scope.itemsSelected.length > 0 && $scope.itemsSelected.forEach(function(data) {
                    data.status = "PASSED_ALONG", $scope.thirdpartycheque.methods.put(data);
                });
                ...
                $scope.$ctrl.onBackClick();
            }, $scope.calcDiscountValue = function($value) {
                return $value.discount && $value.discount.value ? MoneyUtilsService.multiplyMoney($value.discount.value, $value.value) : 0;
            }, $scope.calcPenaltyValue = function($value) {
                return getExpiredDays($value.expiration) && $value.penalty && $value.penalty.value ? MoneyUtilsService.multiplyMoney($value.penalty.value, $value.value) : 0;
            }, $scope.calcInterestValue = function($value) {
                var days = getExpiredDays($value.expiration);
                return days && $value.interest && $value.interest.value ? MoneyUtilsService.divideMoney(MoneyUtilsService.multiplyMoney(MoneyUtilsService.multiplyMoney($value.interest.value, $value.value), days), 30) : 0;
            }, $scope.totalReceive = function() {
                return $scope.payment.methodPayment.reduce(function(sum, current) {
                    return sum + current.value;
                }, 0);
            }, $scope.updateTotal = function(value, interrest, penalty, discount) {
                var expiredDays = getExpiredDays(value.expiration);
                value.interest.value = getInterestPerc(value, interrest, expiredDays), value.penalty.value = getPenaltyPerc(value, penalty, expiredDays), 
                value.discount.value = getDiscountPerc(value, discount), $scope.total = $scope.totalizeRemaining(), 
                $scope.lastPayment = $scope.totalizeRemaining() - $scope.totalReceive();
            }, $scope.isExpired = getExpiredDays, $scope.getFinanceUnits = function(param, name) {
                return FinanceUnitService.findByOpenUnitGroup(name).then(function(data) {
                    return $scope.financeunit.data = data.data.values, data.data.values;
                });
            };
        }
        var receiptPrint = __webpack_require__(8);
    ...
    function ReceivePrintEmbeddedController($scope, $uibModalInstance, items, $filter) {
        ...
        $scope.receiptValue = $filter("gumgaNumberInWords")($scope.recibo.value.toString().replace(".", ","), !0), 
    ...
    (function(moment) {
        function TitleParcelPayListEmbeddedController($uibModal, $scope, TitleParcelPayService, gumgaController, $timeout, IndividualEmbeddedService) {
            ...
            $scope.endDate = new Date(), $scope.paidOut = !1, $scope.containsFullPaid = !1, 
            $scope.lastClicked = null, $scope.gQueryFilters = null, $scope.$watch("individualSearch", function(individual) {
                $scope.individualSearch = individual, $scope.filter($scope.lastClicked, $scope.paidOut);
            }), $scope.filter = function(whichFilter, fullpaid) {
                $scope.paidOut = fullpaid, $scope.lastClicked = whichFilter;
                var gQuery = new GQuery(new Criteria("obj.title.titleType", ComparisonOperator.EQUAL, "PAY")), beginDate = void 0, endDate = void 0;
                switch (whichFilter) {
                  case "thisWeek":
                  ...
                  case "thisMonth":
                    beginDate = moment().startOf("month").format("YYYY-MM-DD"), endDate = moment().endOf("month").format("YYYY-MM-DD");
                    break;

                  case "thisYear":
                    beginDate = moment().startOf("year").format("YYYY-MM-DD"), endDate = moment().endOf("year").format("YYYY-MM-DD");
                    break;

                  case "today":
                    beginDate = moment().format("YYYY-MM-DD") + " 00:00:00", endDate = moment().format("YYYY-MM-DD") + " 23:59:59";
                    break;

                  case "custom":
                    beginDate = moment($scope.endDate).format("YYYY-MM-DD") + " 00:00:00", endDate = moment($scope.endDate).format("YYYY-MM-DD") + " 23:59:59";
                }
                beginDate && endDate && (gQuery = gQuery.and(new Criteria("obj.expiration", ComparisonOperator.BETWEEN, [ beginDate, endDate ]))), 
                $scope.individualSearch && $scope.individualSearch.id && (gQuery = gQuery.and(new Criteria("obj.individual.name", ComparisonOperator.EQUAL, $scope.individualSearch.name))), 
                gQuery = $scope.paidOut ? gQuery.and(new Criteria("obj.fullPaid", ComparisonOperator.EQUAL, !0)) : gQuery.and(new Criteria("obj.fullPaid", ComparisonOperator.EQUAL, !1)), 
                $scope.gQueryFilters = gQuery, $scope.getByGQuery(), $scope.changeSubTypeButton(whichFilter);
                ...
                if ($containsFullPaid) {
                    ...
                    var individualDefault = parcels[0].individual.name, sameIndividual = !0, hasReversed = !1;
                    ...
                    }), sameIndividual && !hasReversed ? (TitleParcelPayService.setInstallmentsPayable(parcels), 
                    $scope.$ctrl.onSameIndividual()) : ($scope.errorMessage = hasReversed ? "Foram selecionados títulos já estornados. Não é possível fazer a movimentação desses títulos." : "Foram selecionadas parcelas de fornecedores diferentes, altere sua seleção.", 
                    $timeout(function() {
                ...
                columnsConfig: [ {
                    ...
                    content: '<span ng-if="!$value.titleData.reversed && $value.totalpayed == 0" class="label label-info">Aberta</span><span ng-if="!$value.titleData.reversed && $value.fullPaid" class="label label-danger">Pago</span><span ng-if="$value.titleData.reversed" class="label label-danger">Estornado</span><span ng-if="!$value.titleData.reversed && ($value.totalpayed > 0) && !$value.fullPaid" class="label label-warning">Amortizado</span>'
                } ]
            ...
            }, $scope.getByGQuery = function(page, pageSize) {
                TitleParcelPayService.getByGQueryMaxDate(null, "PAY", page, $scope.individualSearch, $scope.paidOut, $scope.gQueryFilters, pageSize, $scope.sortField, $scope.sortDir).then(function(data) {
                    $scope.selectedValues = [], $scope.titleparcelPay.data = data.data.values, $scope.titleparcelPay.pageSize = data.data.pageSize, 
                    $scope.titleparcelPay.count = data.data.count, $scope.changeTypeButton($scope.paidOut ? "paid" : "pays");
                });
            }, $scope.sortByGQuery = function(sortField, dir) {
                $scope.sortField = sortField, $scope.sortDir = dir, $scope.getByGQuery();
            };
        }
        var receiptPrint = __webpack_require__(8);
    ...
    (function(moment) {
        function PayReceiveEmbeddedController(FinanceConfigurationService, $scope, $timeout, IndividualCreditService, TitleParcelPayService, IndividualEmbeddedService, DocTedService, BankService, CheckingAccountService, LocalCashService, ChequePortfolioService, ThirdPartyChequeService, gumgaController, PaymentService, $filter, $uibModal, CreditCardAccountService, FinanceUnitService, MoneyUtilsService, PercentageFinanceUtilsService, FinanceReportService) {
            ...
            $scope.receive = 0, $scope.openMomment = function() {
                ...
                [ "interest", "penalty", "discount" ].forEach(function(field) {
                    if ("string" == typeof row[field]) {
                        var newObj = {
                            valueModifierOperation: "discount" === field ? "DECREASE" : "INCREASE",
                ...
                var days = getExpiredDays($value.expiration);
                return days && $value.interest && $value.interest.value ? MoneyUtilsService.divideMoney(MoneyUtilsService.multiplyMoney(MoneyUtilsService.multiplyMoney($value.interest.value, $value.value), days), 30) : 0;
            }, $scope.isExpired = getExpiredDays, $scope.updateTotal = function(value, interrest, penalty, discount) {
                var expiredDays = getExpiredDays(value.expiration);
                value.interest.value = getInterestPerc(value, interrest, expiredDays), value.penalty.value = getPenaltyPerc(value, penalty, expiredDays), 
                value.discount.value = getDiscountPerc(value, discount), $scope.total = $scope.totalizeRemaining(), 
                ...
                return $scope.payment.methodReceive.reduce(function(sum, current) {
                    return sum + current.value;
                }, 0);
            }, $scope.removeLeaf = function(method, index) {
                ...
                var variables = [];
                variables.push("", "parcelIds", items.map(function(item) {
                    return item.id;
                })), variables.push("", "orgName", JSON.parse(window.sessionStorage.getItem("user")).organization), 
                FinanceReportService.openModalViewer("RECEIPT", "", variables, function() {
                ...
                document.getElementById(id).focus(), document.getElementById(id).select();
            }, $scope.balanceFinanceUnit = 0, $scope.onSelectPaymentCredit = function(financeUnit) {
                ...
                $scope.$ctrl.onMakePayment();
            }, $scope.getFinanceUnits = function(param, name) {
                return FinanceUnitService.findByOpenUnitGroup(name).then(function(data) {
                    return $scope.financeunit.data = data.data.values, data.data.values;
                });
            };
    ...
    "use strict";
    (function(moment) {
        function TitleParcelReceiveListEmbeddedController(TitleService, FinanceConfigurationService, $scope, TitleParcelPayService, gumgaController, $timeout, IndividualEmbeddedService, FinanceReportService) {
            new Date();
            ...
            $scope.paidOut = !1, $scope.lastClicked = null, $scope.gQueryFilters = null, $scope.hideOthers = !0, 
            $scope.$watch("individualSearch", function(individual) {
                ...
                var variables = [], sql = " in (".concat(items.parcels.reduce(function(final, current) {
                    return final + "," + current.id;
                }, "")).concat(")").replace("(,", "(");
                variables.push(FinanceReportService.mountVariable("", "parcelIds", sql)), variables.push(FinanceReportService.mountVariable("", "orgName", JSON.parse(window.sessionStorage.getItem("user")).organization)), 
                FinanceReportService.openModalViewer("RECEIPT", "", variables, function() {
                    SweetAlert.swal("Falta de Recibos", "Você esta sem o recibo configurado contate o suporte.", "warning");
                });
            }, $scope.individualCheckAndPay = function(parcels, $containsFullPaid) {
                ...
                TitleParcelPayService.getByGQueryMaxDate(null, "RECEIVE", page, $scope.individualSearch, $scope.paidOut, $scope.gQueryFilters, pageSize, $scope.sortField, $scope.sortDir).then(function(data) {
                    $scope.selectedValues = [], $scope.titleparcel.data = data.data.values, $scope.titleparcel.pageSize = data.data.pageSize, 
                    $scope.titleparcel.count = data.data.count, $scope.changeTypeButton($scope.paidOut ? "paid" : "pays");
                });
            }, $scope.sortByGQuery = function(sortField, dir) {
                $scope.sortField = sortField, $scope.sortDir = dir, $scope.getByGQuery();
            }, $scope.filter = function(whichFilter, fullpaid) {
                $scope.paidOut = fullpaid, $scope.lastClicked = whichFilter;
                var gQuery = new GQuery(new Criteria("obj.title.titleType", ComparisonOperator.EQUAL, "RECEIVE")), startDate = void 0, endDate = void 0;
                switch (whichFilter) {
                  case "thisWeek":
                    startDate = moment().startOf("isoWeek").subtract(1, "days"), endDate = moment().endOf("isoWeek").subtract(1, "days");
                    break;
                  ...
                  case "custom":
                    startDate = moment($scope.endDate), endDate = moment($scope.endDate);
                }
                startDate && endDate && (gQuery = gQuery.and(new Criteria("obj.expiration", ComparisonOperator.BETWEEN, [ startDate, endDate ]))), 
                $scope.individualSearch && $scope.individualSearch.id && (gQuery = gQuery.and(new Criteria("obj.individual.name", ComparisonOperator.EQUAL, $scope.individualSearch.name))), 
                gQuery = $scope.paidOut ? gQuery.and(new Criteria("obj.fullPaid", ComparisonOperator.EQUAL, !0)) : gQuery.and(new Criteria("obj.fullPaid", ComparisonOperator.EQUAL, !1)), 
                $scope.gQueryFilters = gQuery, $scope.getByGQuery(), $scope.changeSubTypeButton(whichFilter);
            };
        ...
        __webpack_require__(9);
        TitleParcelReceiveListEmbeddedController.$inject = [ "TitleService", "FinanceConfigurationService", "$scope", "TitleParcelPayService", "gumgaController", "$timeout", "IndividualEmbeddedService", "FinanceReportService" ], 
    ...
    "use strict";
    __webpack_require__(2), module.exports = angular.module("finance.stimulsoftembedded.components", [ "finance.stimulsoftembedded.controllers" ]).component("financeReportDesignerEmbedded", __webpack_require__(43)).component("financeReportListEmbedded", __webpack_require__(44)).component("financeReportViewerEmbedded", __webpack_require__(45));
}, function(module, exports, __webpack_require__) {
    "use strict";
    function DesignerEmbeddedController($scope, $window, FinanceReportService, $uibModal) {
        function saveReportType(entity) {
            $uibModal.open({
                ...
                result.isDefault = result.isDefault || !1, FinanceReportService.update(result).then(function(data) {
                    $scope.entity = data.data.data;
                });
            });
        }
        function configureOptions() {
            StiOptions.WebServer.url = FinanceReportService.connectionLocal, StiOptions.Services._databases = [], 
        ...
        function changeSaveReport(designer) {
            designer.onSaveReport = function(event) {
                event.report.reportName = event.fileName, event.report.reportAlias = event.fileName;
                var jsonStr = event.report.saveToJsonString();
                $scope.entity.report = $scope.entity.report || {}, $scope.entity.report.name = event.fileName, 
                $scope.entity.report.definition = jsonStr, saveReportType($scope.entity);
            };
        }
        $scope.entity = angular.copy($scope.$ctrl.entity), $scope.variable = angular.copy($scope.$ctrl.variable), 
        $scope.back = function() {
            $scope.$ctrl.backState({
                $type: $scope.entity.reportType
            });
        }, $scope.init = function() {
            configureOptions();
            var options = new $window.Stimulsoft.Designer.StiDesignerOptions();
            options.appearance.fullScreenMode = !1, options.height = "940px";
            var designer = new $window.Stimulsoft.Designer.StiDesigner(options, "StiDesigner", !1), report = new $window.Stimulsoft.Report.StiReport();
            if ($scope.entity.id) report.load($scope.entity.report.definition); else {
                report.dictionary.databases.clear();
                report.dictionary.databases.clear(), report.dictionary.databases.add(new Stimulsoft.Report.Dictionary.StiPostgreSQLDatabase("PostgreSQL", "PostgreSQL", "url = jdbc:postgresql://%address/%db?currentSchema=%schema; user = %user; password = %pass;")), 
                report.dictionary.synchronize();
            }
            report.dictionary.variable = $scope.variable, changeSaveReport(designer), designer.report = report, 
            designer.renderHtml("designer");
        };
    }
    var templateModal = __webpack_require__(91);
    DesignerEmbeddedController.$inject = [ "$scope", "$window", "FinanceReportService", "$uibModal" ], 
    ...
    function FinanceReportListEmbeddedController($scope, FinanceReportService, gumgaController, $state, $q, SweetAlert, $rootScope, TitleService) {
        ...
        $scope.inicialDate = new Date(), $scope.finalDate = new Date(), $scope.statusList = [ "Todos", "Aberto", "Pago", "Estornado", "Amortizado" ], 
        $scope.status = $scope.statusList[0], $scope.filterClient = null, $scope.financeReport.methods.get = function(page) {
            FinanceReportService.getByType(page, $scope.type).then(function(data) {
                $scope.financeReport.data = data.data.values, $scope.financeReport.pageSize = data.data.pageSize, 
                $scope.financeReport.count = data.data.count, $scope.financeReport.page = page || 1;
            });
        }, $scope.financeReport.execute("reset"), $scope.financeReport.execute("get"), FinanceReportService.getReportType().then(function(data) {
            var newData = {
                label: "Todos"
            };
            $scope.reportType = data.data, $scope.reportType.splice(0, 0, newData);
        }), $scope.delete = function(entity) {
            if (entity.oi) {
                var confirmReversal = function(isConfirm) {
                    isConfirm && FinanceReportService.delete(entity).then(function() {
            ...
            } else SweetAlert.swal("Este relatório não pode ser apagado", "Este relatório não pode ser apagado pois é de dominio publico.", "warning");
        }, $scope.insertReport = function() {
            variables = [], $scope.$ctrl.insertReport();
        }, $scope.editReport = function(entity) {
            variables = [], $scope.$ctrl.editReport({
                $value: entity,
                variables: variables
            });
        };
        var mountVariable = function(category, name, value) {
            var variable = new Stimulsoft.Report.Dictionary.StiVariable();
            return variable.category = category, variable.name = name, variable.alias = name, 
            variable.description = "", variable.value = value, variable.readOnly = !0, variable.typeT = String, 
            variable.requestFromUser = !1, variable.key = null, variable.allowUseAsSqlParameter = !1, 
            variable;
        };
        $scope.viewReport = function(entity) {
            variables.push(mountVariable("", "inicialDate", $scope.inicialDate)), variables.push(mountVariable("", "finalDate", $scope.finalDate)), 
            variables.push(mountVariable("", "filterClient", $scope.filterClient)), $scope.$ctrl.viewReport({
                $value: entity,
                variables: variables
            });
        }, $scope.copyReport = function(entity) {
            var newEntity = angular.copy(entity), oi = {
                value: JSON.parse(window.sessionStorage.getItem("user")).organizationHierarchyCode
            };
            delete newEntity.id, delete newEntity.report.id, newEntity.oi = oi, newEntity.report.oi = oi, 
            ...
            columnsConfig: [ {
                ...
                size: "col-md-1",
                title: "  ",
                content: '<button style="display:inline-block" type="button" ng-click="$parent.$parent.editReport($value)" uib-tooltip="Editar" class="btn-link center-block text-primary"><i class="fa fa-pencil-square-o"></i></button><button style="display:inline-block" type="button" ng-click="$parent.$parent.viewReport($value)" uib-tooltip="Visualizar Relatório" class="btn-link btn-xs"><i class="fa fa-search"></i></button><button style="display:inline-block" type="button" ng-click="$parent.$parent.copyReport($value)" uib-tooltip="Copiar Relatório" class="btn-link btn-xs text-navy"><i class="fa fa-plus"></i></button><button style="display:inline-block" uib-tooltip="Relatório Público" type="button" class="btn-link btn-xs center-block " ng-show="!$value.oi || !$value.oi.value"><i class="fa fa-users"></i></button>'
            } ]
        }, $scope.changeDefault = function(report) {
            report.oi && report.oi.value && (report.isDefault = !report.isDefault, $rootScope.$emit("hideNextMessage"), 
            FinanceReportService.save(report).then(function() {
                $scope.changeReports();
            }));
        }, $scope.changeReports = function() {
            filters = "", $scope.financeReport.execute("reset"), $scope.financeReport.execute("get");
        };
    }
    __webpack_require__(90), FinanceReportListEmbeddedController.$inject = [ "$scope", "FinanceReportService", "gumgaController", "$state", "$q", "SweetAlert", "$rootScope", "TitleService" ], 
    module.exports = FinanceReportListEmbeddedController;
}, function(module, exports, __webpack_require__) {
    "use strict";
    function ReportTypeModalEmbeddedController($scope, FinanceReportService, $uibModalInstance, entity) {
        $scope.entity = angular.copy(entity), FinanceReportService.getReportType().then(function(data) {
            $scope.reportType = data.data;
        }), $scope.continue = function() {
            $uibModalInstance.close($scope.entity);
        };
    }
    ReportTypeModalEmbeddedController.$inject = [ "$scope", "FinanceReportService", "$uibModalInstance", "entity" ], 
    module.exports = ReportTypeModalEmbeddedController;
}, function(module, exports, __webpack_require__) {
    "use strict";
    function ViewerEmbeddedController($scope, $window, FinanceReportService) {
        function init() {
            StiOptions.WebServer.url = FinanceReportService.connectionLocal;
            var viewer = new $window.Stimulsoft.Viewer.StiViewer(null, "StiViewer", !1), report = new $window.Stimulsoft.Report.StiReport(), jsonReport = $scope.entity.report.definition;
            $scope.entity.id && report.load(jsonReport), report.dictionary.variable = variableVar, 
            variableVar.forEach(function(vars) {
                report.dictionary.variables.list.forEach(function(item) {
                    item.name == vars.name && (item.val = vars.val, item.value = vars.value, item.valueObject = vars.valueObject);
                });
            }), viewer.report = report, viewer.renderHtml("viewer"), viewer.onBeginProcessData = function(event) {
                var index, queryBegin = "", queryEnd = "";
                if (!Array.isArray(filtersVar)) {
                    var where = "";
                    event.queryString.match(/where/i) || (where = " where 1=1 "), event.queryString.match(/group by/i) ? (index = event.queryString.match(/group by/i).index, 
                    queryBegin = event.queryString.substring(0, index - 1), queryEnd = event.queryString.substring(index, event.queryString.length)) : event.queryString.match(/order by/i) ? (index = event.queryString.match(/order by/i).index, 
                    queryBegin = event.queryString.substring(0, index - 1), queryEnd = event.queryString.substring(index, event.queryString.length)) : (index = event.queryString.length, 
                    queryBegin = event.queryString.substring(0, index)), event.queryString = " " + queryBegin + " " + where + " " + filtersVar + " " + queryEnd + " ";
                }
                if (Array.isArray(filtersVar)) {
                    var query = angular.copy(event.queryString), queryMod = " ";
                    filtersVar.length ? filtersVar.forEach(function(data) {
                        for (var i = 1; i <= data.count; i++) queryMod = queryMod ? queryMod + " UNION ALL " + query + " WHERE obj.id = " + data.id + " " : query + " WHERE obj.id = " + data.id + " ";
                    }) : queryMod = query, event.queryString = queryMod;
                }
            }, $scope.close = function() {
                $scope.$dismiss();
            };
        }
        var variableVar = void 0, filtersVar = void 0;
        $scope.$resolve ? (variableVar = angular.copy($scope.$resolve.variable), filtersVar = angular.copy($scope.$resolve.filters), 
        $scope.entity = angular.copy($scope.$resolve.entity)) : ($scope.entity = angular.copy($scope.$ctrl.entity), 
        variableVar = angular.copy($scope.$ctrl.variable), filtersVar = angular.copy($scope.$ctrl.filters), 
        init()), $scope.back = function() {
            $scope.$ctrl.backState({
                $type: $scope.entity.reportType
            });
        }, $scope.init = init;
    }
    ViewerEmbeddedController.$inject = [ "$scope", "$window", "FinanceReportService" ], 
    ...
    function FinanceReportService(GumgaRest, $uibModal, FinanceEmbeddedService) {
        ...
        return service.getReportType = function() {
        ...
        }, service.setConnectionLocal(), service.getByType = function(page, type) {
            if (page) {
                if (page < 1) throw "Invalid page";
                this._query.params.start = (page - 1) * this._query.params.pageSize;
            }
            return type && (this._query.params.aq = "obj.type = '" + type + "'"), service.extend("get", "", this._query);
        }, service.getDefault = function(type) {
            return service.extend("get", "/getdefault/" + type);
        }, service.mountVariable = function(category, name, value) {
            var variable = new Stimulsoft.Report.Dictionary.StiVariable();
            return variable.category = category, variable.name = name, variable.alias = name, 
            variable.description = "", variable.value = value, variable.readOnly = !0, variable.typeT = String, 
            variable.requestFromUser = !1, variable.key = null, variable.allowUseAsSqlParameter = !1, 
            variable;
        }, service.openModalViewer = function(type, _filters, variables, noReport) {
            service.getDefault(type).then(function(response) {
                response.data ? $uibModal.open({
                    templateUrl: modalTemplate,
                    controller: "ViewerEmbeddedController",
                    backdrop: "static",
                    size: "lg",
    ...
    var modalTemplate = __webpack_require__(93);
    ...
    var _DynamicController = __webpack_require__(10), _DynamicController2 = _interopRequireDefault(_DynamicController), _bindHtmlCompile = __webpack_require__(12), _bindHtmlCompile2 = _interopRequireDefault(_bindHtmlCompile);
    __webpack_require__(20), __webpack_require__(18), __webpack_require__(13), __webpack_require__(14), 
    __webpack_require__(15), __webpack_require__(16), __webpack_require__(17), __webpack_require__(19), 
    __webpack_require__(1), __webpack_require__(11);
    var finance = angular.module("finance.embedded", [ "ui.bootstrap", "group.dependencies", "finance.providers", "finance.services", "finance.title", "finance.titleparcel", "finance.titleparcelreceive", "finance.stimulsoftembedded", "finance.cashcheckinembedded", "finance.cashcheckoutembedded", "gumga.date" ]);
    ...
    function FinanceUnitService(GumgaRest, $http, FinanceEmbeddedService) {
        ...
        }, Service.getFinanceUnitBalance = function(financeUnitId) {
    ...
    function MoneyUtilsService() {
        this.roundMoney = function(value) {
            ...
            return Math.floor(Math.round(Math.abs(100 * value))) / 100 * signal;
        }, this.sumMoney = function(value1, value2) {
            return (Math.round(100 * value1) + Math.round(100 * value2)) / 100;
        }, this.divideMoney = function(money, divider) {
            return this.roundMoney(Math.round(100 * money) / divider / 100);
        }, this.multiplyMoney = function(money, multiplier) {
            return this.roundMoney(Math.round(100 * money * (100 * multiplier)) / 1e4);
        };
    }
    MoneyUtilsService.$inject = [], module.exports = MoneyUtilsService;
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    function PercentageFinanceUtilsService() {
        this.round = function(value) {
            var signal = value > 0 ? 1 : -1;
            return Math.floor(Math.round(Math.abs(1e4 * value))) / 1e4 * signal;
        }, this.sum = function(value1, value2) {
            return (Math.round(1e4 * value1) + Math.round(1e4 * value2)) / 1e4;
        }, this.divide = function(money, divider) {
            return this.round(Math.round(1e4 * money) / divider / 1e4);
        }, this.multiply = function(money, multiplier) {
            return this.round(Math.round(1e4 * money * (1e4 * multiplier)) / 1e8);
        }, this.round6 = function(value) {
            var signal = value > 0 ? 1 : -1;
            return Math.floor(Math.round(Math.abs(1e6 * value))) / 1e6 * signal;
        }, this.sum6 = function(value1, value2) {
            return (Math.round(1e6 * value1) + Math.round(1e6 * value2)) / 1e6;
        }, this.divide6 = function(money, divider) {
            return this.round6(Math.round(1e6 * money) / divider / 1e6);
        }, this.multiply6 = function(money, multiplier) {
            return this.round6(Math.round(1e6 * money * (1e6 * multiplier)) / 1e12);
        };
    }
    PercentageFinanceUtilsService.$inject = [], module.exports = PercentageFinanceUtilsService;
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    function TitleParcelPayService(GumgaRest, $http, FinanceEmbeddedService) {
        ...
        return Service.findOpenByMaxDate = function(date, type, page, individual, paidOut, aqFilterSelected) {
            ...
            null === gQuery ? (gQuery = new GQuery(), date && (gQuery = gQuery.and(new Criteria("expiration", ComparisonOperator.LOWER_EQUAL, format(date, "yyyy-MM-dd") + "'"))), 
            individual && (gQuery = gQuery.and(new Criteria("individual.id", ComparisonOperator.EQUAL, individual.id))), 
            gQuery = gQuery.and(new Criteria("title.titleType", ComparisonOperator.EQUAL, type)).and(new Criteria("title.isReversed", ComparisonOperator.EQUAL, !1)).and(new GQuery(new Criteria("obj.fullPaid", ComparisonOperator.EQUAL, paidOut)))) : gQuery = gQuery.and(new Criteria("title.isReversed", ComparisonOperator.EQUAL, !1)), 
            page = page && 1 !== page ? 10 * page - 10 : 0;
            var qo = {
                gQuery: gQuery,
                start: page || 0,
                pageSize: pageSize || 10
            };
            return sortField && (qo.sortField = sortField, qo.sortDir = sortDir), Service.sendQueryObject(qo);
    ...
    !function(root, factory) {
        ...
        function unpackBase60(string) {
            var num, i = 0, parts = string.split("."), whole = parts[0], fractional = parts[1] || "", multiplier = 1, out = 0, sign = 1;
            for (45 === string.charCodeAt(0) && (i = 1, sign = -1), i; i < whole.length; i++) num = charCodeToInt(whole.charCodeAt(i)), 
            out = 60 * out + num;
            for (i = 0; i < fractional.length; i++) multiplier /= 60, num = charCodeToInt(fractional.charCodeAt(i)), 
            out += num * multiplier;
            return out * sign;
        }
        ...
        function OffsetAt(at) {
            ...
            abbr && abbr[0] ? (abbr = abbr[0].match(/[A-Z]/g), abbr = abbr ? abbr.join("") : void 0) : (abbr = timeString.match(/[A-Z]{3,5}/g), 
            abbr = abbr ? abbr[0] : void 0), "GMT" === abbr && (abbr = void 0), this.at = +at, 
            this.abbr = abbr, this.offset = at.getTimezoneOffset();
        }
        function ZoneScore(zone) {
            this.zone = zone, this.offsetScore = 0, this.abbrScore = 0;
        }
        function findChange(low, high) {
            for (var mid, diff; diff = 6e4 * ((high.at - low.at) / 12e4 | 0); ) mid = new OffsetAt(new Date(low.at + diff)), 
            mid.offset === low.offset ? low = mid : high = mid;
            return low;
        }
        function userOffsets() {
            var change, next, i, startYear = new Date().getFullYear() - 2, last = new OffsetAt(new Date(startYear, 0, 1)), offsets = [ last ];
            for (i = 1; i < 48; i++) next = new OffsetAt(new Date(startYear, i, 1)), next.offset !== last.offset && (change = findChange(last, next), 
        ...
        function rebuildGuess() {
            ...
            var zoneScore, i, j, offsets = userOffsets(), offsetsLength = offsets.length, guesses = guessesForUserOffsets(offsets), zoneScores = [];
        ...
        function addZone(packed) {
            ...
            for ("string" == typeof packed && (packed = [ packed ]), i = 0; i < packed.length; i++) split = packed[i].split("|"), 
            name = split[0], normalized = normalizeName(name), zones[normalized] = packed[i], 
            names[normalized] = name, split[5] && addToGuesses(normalized, split[2].split(" "));
        }
        function getZone(name, caller) {
            name = normalizeName(name);
            var link, zone = zones[name];
            return zone instanceof Zone ? zone : "string" == typeof zone ? (zone = new Zone(zone), 
            zones[name] = zone, zone) : links[name] && caller !== getZone && (link = getZone(links[name], getZone)) ? (zone = zones[name] = new Zone(), 
            zone._set(link), zone.name = names[name], zone) : null;
        }
        function getNames() {
            var i, out = [];
        ...
        function addLink(aliases) {
            ...
            for ("string" == typeof aliases && (aliases = [ aliases ]), i = 0; i < aliases.length; i++) alias = aliases[i].split("|"), 
            normal0 = normalizeName(alias[0]), normal1 = normalizeName(alias[1]), links[normal0] = normal1, 
            names[normal0] = alias[0], links[normal1] = normal0, names[normal1] = alias[1];
        }
        ...
        var cachedGuess, zones = {}, links = {}, names = {}, guesses = {}, momentVersion = moment.version.split("."), major = +momentVersion[0], minor = +momentVersion[1];
        ...
        Zone.prototype = {
            ...
            parse: function(timestamp) {
                ...
                offsetPrev = offsets[i ? i - 1 : i], offset < offsetNext && tz.moveAmbiguousForward ? offset = offsetNext : offset > offsetPrev && tz.moveInvalidForward && (offset = offsetPrev), 
            ...
            this.offsetScore += Math.abs(this.zone.offset(offsetAt.at) - offsetAt.offset), this.zone.abbr(offsetAt.at).replace(/[^A-Z]/g, "") !== offsetAt.abbr && this.abbrScore++;
        }, tz.version = "0.5.13", tz.dataVersion = "", tz._zones = zones, tz._links = links, 
        tz._names = names, tz.add = addZone, tz.link = addLink, tz.load = loadData, tz.zone = getZone, 
        tz.zoneExists = zoneExists, tz.guess = guess, tz.names = getNames, tz.Zone = Zone, 
        tz.unpack = unpack, tz.unpackBase60 = unpackBase60, tz.needsOffset = needsOffset, 
        tz.moveInvalidForward = !0, tz.moveAmbiguousForward = !1;
        var fn = moment.fn;
        moment.tz = tz, moment.defaultZone = null, moment.updateOffset = function(mom, keepTime) {
            var offset, zone = moment.defaultZone;
            void 0 === mom._z && (zone && needsOffset(mom) && !mom._isUTC && (mom._d = moment.utc(mom._a)._d, 
            mom.utc().add(zone.parse(mom), "minutes")), mom._z = zone), mom._z && (offset = mom._z.offset(mom), 
            Math.abs(offset) < 16 && (offset /= 60), void 0 !== mom.utcOffset ? mom.utcOffset(-offset, keepTime) : mom.zone(offset, keepTime));
        }, fn.tz = function(name) {
            return name ? (this._z = getZone(name), this._z ? moment.updateOffset(this) : logError("Moment Timezone has no data for " + name + ". See http://momentjs.com/timezone/docs/#/data-loading/."), 
            this) : this._z ? this._z.name : void 0;
        }, fn.zoneName = abbrWrap(fn.zoneName), fn.zoneAbbr = abbrWrap(fn.zoneAbbr), fn.utc = function(old) {
            return function() {
                return this._z = null, old.apply(this, arguments);
            };
        }(fn.utc), moment.tz.setDefault = function(name) {
    ...
    var path = "/financeTitle/views/PaymentsModal.html";
    window.angular.module("ng").run([ "$templateCache", function(c) {
    ...
    var path = "/financeTitle/views/receiveTitlePrintModal.html";
    window.angular.module("ng").run([ "$templateCache", function(c) {
    ...
    var path = "/financereport/views/viewermodal.html";
    window.angular.module("ng").run([ "$templateCache", function(c) {
        c.put(path, '<div class="modal-header"><h3 class="modal-title">Impressão</h3></div>\n<div class="modal-body">\n    <div class="row">\n        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: -10px">\n            <p ng-init="init()"></p>\n            <div id="viewer"></div>\n        </div>\n    </div>\n</div>\n<div class="modal-footer">\n    <button type="button" class="btn btn-primary pull-right button-ok" style="color: #fff;" ng-click="close()">\n        Fechar\n        <i class="fa fa-arrow-right"></i>\n    </button>\n</div>');
    } ]), module.exports = path;
}, function(module, exports) {
