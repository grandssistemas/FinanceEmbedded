!function(modules) {
    ...
    "use strict";
    (function(moment) {
        function TitleFormEmbeddedController(TitleService, $uibModal, $scope, gumgaController, $timeout, IndividualEmbeddedService, DocumentTypeService, RatioPlanService, PlanLeafService, WalletService, FinanceUnitService, SweetAlert, MoneyUtils, TitleParcelPayService) {
        ...
        TitleFormEmbeddedController.$inject = [ "TitleService", "$uibModal", "$scope", "gumgaController", "$timeout", "IndividualEmbeddedService", "DocumentTypeService", "RatioPlanService", "PlanLeafService", "WalletService", "FinanceUnitService", "SweetAlert", "MoneyUtilsService", "TitleParcelPayService" ], 
