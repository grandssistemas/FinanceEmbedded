!function(modules) {
    ...
    (function(moment) {
        function TitleParcelPayListEmbeddedController($uibModal, $scope, TitleParcelPayService, gumgaController, $timeout, IndividualEmbeddedService) {
            ...
            $scope.lastClicked = null, $scope.aqFilterSelected = null, $scope.getParcels = function(date, page) {
    ...
    (function(moment) {
        function TitleParcelReceiveListEmbeddedController(TitleService, FinanceConfigurationService, $scope, TitleParcelPayService, gumgaController, $timeout, IndividualEmbeddedService, FinanceReportService) {
            function cleanFilter() {
                $scope.lastClicked = null, $scope.aqFilterSelected = null, $scope.hideOthers = !0, 
                dateEnd = null, dateStart = null, delete $scope.filters, delete $scope.individualSearch, 
                $scope.selectedSubType = "";
            }
            var dateStart = null, dateEnd = new Date();
            ...
            $scope.hideOthers = !0, $scope.sort = function(field, dir) {
                ...
                var hql = "obj.title.titleType = 'RECEIVE' AND (obj.fullPaid = " + $scope.paidOut + " OR obj.fullPaid is null)";
                dateStart && (hql += " AND obj.expiration >= '" + moment(dateStart).format("YYYY-MM-DD") + " 00:00:00'"), 
                dateEnd && (hql += " AND obj.expiration <= '" + moment(dateEnd).format("YYYY-MM-DD") + " 23:59:59'"), 
                $scope.individualSearch && (hql += " AND obj.individual.id = " + $scope.individualSearch.id), 
                ...
                cleanFilter(), $scope.individualSearch = individual, $scope.getParcels(null, 1);
            }), $scope.filter = function(whichFilter) {
                $scope.lastClicked = whichFilter;
                ...
                $scope.changeSubTypeButton(whichFilter), dateStart = startDate ? startDate._d : null, 
                dateEnd = endDate ? endDate._d : null, $scope.getParcels();
            }, $scope.searchByIndividual = function(individual) {
                $scope.getParcels($scope.endDate, 1);
            }, $scope.receive = function(label) {
                cleanFilter(), $scope.lastClicked = null, $scope.aqFilterSelected = null, $scope.paidOut = "RECEIVE" === label, 
                $scope.selectedSubType = "", delete $scope.filters, $scope.hideOthers = !0, $scope.changeTypeButton(label), 
                $scope.getParcels();
            }, $scope.toReceive = function(page) {
                $scope.lastClicked = null, $scope.aqFilterSelected = null, $scope.paidOut = !1, 
                $scope.selectedSubType = "", delete $scope.filters, $scope.hideOthers = !0, TitleParcelPayService.findOpenByMaxDate(null, "RECEIVE", page, $scope.individualSearch, $scope.paidOut, $scope.aqFilterSelected).then(function(data) {
                    $scope.selectedValues = [], $scope.titleparcel.data = data.data.values, $scope.titleparcel.pageSize = data.data.pageSize, 
