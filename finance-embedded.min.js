    ...
    (function(moment) {
        function TitleFormEmbeddedController(TitleService, $uibModal, $scope, gumgaController, $timeout, IndividualEmbeddedService, DocumentTypeService, RatioPlanService, PlanLeafService, WalletService, FinanceUnitService, SweetAlert, MoneyUtils, TitleParcelPayService) {
            ...
            $scope.calculateParcels = function() {
                ...
                $scope.title.data.parcel = [], valueParcelReceive < .01 && (SweetAlert.swal("Atenção!", "O valor das parcelas não deve ser menor que R$ 0,01 centavo", "warning"), 
    ...
    (function(moment) {
        function PayReceiveEmbeddedController(FinanceConfigurationService, $scope, $timeout, IndividualCreditService, TitleParcelPayService, IndividualEmbeddedService, DocTedService, BankService, CheckingAccountService, LocalCashService, ChequePortfolioService, ThirdPartyChequeService, gumgaController, PaymentService, $filter, $uibModal, CreditCardAccountService, FinanceUnitService, MoneyUtilsService, PercentageFinanceUtilsService, FinanceReportService) {
            ...
            $scope.receive = 0, $scope.openMomment = function() {
                ...
                $scope.post = payment, console.log(payment), PaymentService.receive(payment).then(function() {
                    $scope.$ctrl.onMakePayment();
                });
            }, $scope.setarfocusPayment = function(value) {
                switch (value) {
