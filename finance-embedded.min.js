!function(modules) {
    ...
    (function(moment) {
        function TitleFormEmbeddedController(TitleService, $uibModal, $scope, gumgaController, $timeout, IndividualEmbeddedService, DocumentTypeService, RatioPlanService, PlanLeafService, WalletService, FinanceUnitService, SweetAlert, MoneyUtils) {
            ...
            console.log($scope.title.data.expiration, 1), "PAY" === $scope.title.data.titleType && ($scope.title.data.value = $scope.title.data.parcel[0].value), 
            ...
            $scope.save = function(entity) {
                ...
                entity.parcel = entity.parcel.map(function(data) {
                    return data.expiration && (data.expiration = moment(data.expiration).tz("America/Sao_Paulo").format("YYYY-MM-DDTHH:mm:ss") + "Z"), 
                    data;
            ...
            $scope.calculateParcels = function() {
                ...
                $scope.title.data.parcel[index].expiration = moment(params.expiration)._d, params.fullPaid || ($scope.paymentRest += params.value), 
                "1" === params.number && (console.log(params.expiration, moment(params.expiration)._d, 2), 
